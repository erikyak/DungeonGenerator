...
Этот проект представляет модуль генерации подземелий для игр на Unity. Он использует модульную архитектуру для создания процедурно генерируемых карт с различными типами комнат (вход, выход, босс, сокровищница, боевая комната) и коридоров, обеспечивая гибкость и возможность расширения.
